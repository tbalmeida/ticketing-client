...
const theme = createMuiTheme({  
  ...
  typography: { "fontFamily": "RobotoCondensed" }})//default primary and secondary color of font The theme specifies the color of the components, darkness of the surfaces, level of shadow, appropriate opacity of ink elements, etc.
const App = () => (
  <>
  <GlobalStyles />
    <BrowserRouter >
