...
const theme = createMuiTheme({  palette: {    primary: { main: '#f7faf1', secondary: 'black'  }}}) //default primary and secondary color of font The theme specifies the color of the components, darkness of the surfaces, level of shadow, appropriate opacity of ink elements, etc.
const App = () => (
  <>
  <GlobalStyles />
    <BrowserRouter >
